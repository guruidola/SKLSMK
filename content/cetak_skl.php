          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Cetak Surat Keterangan Lulus</h3>

             
              <div class="card-tools">
                <a  class="btn btn-block btn-primary btn-sm" onClick="window.open('skhuns.php','mywindow','width=1000,location=no')"><i class="fa fa-print"></i> Cetak</a>              
              </div>
            </div>
              <div class="card-body">
